...
export interface FxRoundOutput {
  index: number;
  queryCellId: string;
  final: string;
  steps?: FxRoundStep[];
...
export interface FxNotebook { version: 1; id: string; title: string; cells: NotebookCell[]; }
...
export interface RunHooks {
  onEvent?: (event: FxEvent) => void | Promise<void>;
  signal?: AbortSignal;
  resume?: OutputCell;
}
