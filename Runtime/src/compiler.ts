import type { CompiledRun, ContextCell, FxNotebook, OutputCell, QueryPart } from "./types.ts";
...
export function compileAgent(notebook: FxNotebook, agentId: string): CompiledRun {
