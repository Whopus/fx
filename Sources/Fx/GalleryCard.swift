...
struct GalleryCard: View {
    ...
    private var actionOverlay: some View {
        VStack {
            HStack {
                Spacer()
                if isHovered || isActionMenuPresented {
                    ...
                    GlassMenu(entries: [
                        GlassMenuEntry(id: "details", title: "View details", icon: "info.circle", action: { onOpenDetails() }),
                        GlassMenuEntry(id: "cover", title: "Replace cover", icon: "photo.badge.arrow.down", action: { onReplaceCover() }),
                        GlassMenuEntry(id: "source", title: "Open source", icon: "arrow.up.right.square",
                            enabled: !(item.sourceURL == nil && item.videoURL == nil && item.imageURL?.isFileURL != false), action: { onOpenSource() }),
                        item.isTrashed
                            ? GlassMenuEntry(id: "restore", title: "Restore", icon: "arrow.uturn.backward", action: { onRestore() })
                            : GlassMenuEntry(id: "trash", title: "Move to Trash", icon: "trash", destructive: true, action: { onTrash() })
                    ], accessibilityTitle: "Item actions", isPresented: $isActionMenuPresented) {
